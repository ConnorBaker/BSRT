...
def main_worker(local_rank, nprocs, args):
    if checkpoint.ok:
        ...
        if args.data_type == "synthetic":
            ...
            valid_data = SyntheticBurstVal(root=args.val_root)
            ...
            valid_data = BurstSRDataset(
                root=args.root, burst_size=14, crop_sz=80, split="val"
            )

        else:
            raise Exception("Unrecognized data_type: expected synthetic or real")
