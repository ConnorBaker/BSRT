...
def bilinear_upsample_2d(t: Tensor, scale_factor: Optional[float] = None, size: Optional[tuple[int, int]] = None, align_corners: Optional[bool] = False, recompute_scale_factor: Optional[bool] = None) -> Tensor:
